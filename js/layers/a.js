addLayer("a", {
	...
	achievements: {
		...
		31: {
			...
			style() { return hasAchievement(this.layer, 35) ? {"border-radius":"0px 0px 0px 0px"} : {"border-radius":"0px 0px 0px 10px"} },
		...
		35: {
			...
			tooltip: "Not implimented",
			style() { return hasAchievement(this.layer, 35) ? {"border-radius":"0px 0px 0px 0px"} : {"border-radius":"0px 0px 10px 0px"} },
			unlocked() { return hasAchievement(this.layer, 25) },
		},
	},
})
